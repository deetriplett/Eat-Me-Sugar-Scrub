...
$products[1] = array(
  ...
  "description" => "Children aren't the only cause of gray hair. Halt premature aging of the skin with our Rosemarried with Children sugar scrub.
    Rosemary promotes healthy, moisturized skin and supports healthy collagen levels. It protects from free-radical damage which compromises the support structure in your skin, leading to wrinkles,
...
$products[3] = array(
    ...
    "price" => 13.95,
    "description" => "Bye Bye blackheads, acne, and pimples. Hello blemish free, glowing skin. The combo of these two powerhouse herbs
    ...
    and hop into a warm bath with this extraordinary sugar scrub. Lavender is excellent for treating tired muscles, especially the feet."
);
$products[4] = array(
    "name" => "Oh Wise Sage (with Blackberries)",
    "img" => "img/sage.jpg",
    "price" => 12.95,
    ...
    into a real power house of a cleanser. The antioxidants in blackberries and sage reverse the signs of aging such as wrinkles, fine lines, and age spots."
);
$products[5] = array(
...
$products[7] = array(
    ...
    zingy mint, this sugar scrub is sure to please, not only your senses but your skin too. Just try not to eat it."
);
$products[8] =  array(
